	<p>
	<?php _e( 'Click below to connect your calendar to Facebook.', AI1ECFI_PLUGIN_NAME ); ?>
	</p>
	<div id="ai1ec-facebook-connect" class="ai1ec-feed-container">
		<a class="ai1ec-btn ai1ec-btn-primary" href="<?php echo $login_url ?>">
			...
			<?php _e( 'Connect to Facebook', AI1ECFI_PLUGIN_NAME ) ?>
		</a>
		<?php echo $question_mark ?>
	</div>
	<input type="hidden" value="<?php echo $nonce ?>" id="ai1ec_facebook_feeds" name="ai1ec_facebook_feeds" />
