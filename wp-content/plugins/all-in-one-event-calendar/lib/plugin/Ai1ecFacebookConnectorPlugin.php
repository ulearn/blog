...
class Ai1ecFacebookConnectorPlugin extends Ai1ec_Connector_Plugin {
	...
	const FB_INFO_VARIABLE                  = '<label><a href="http://support.time.ly/connect-your-calendar-to-facebook/" target="_blank">How do I use Facebook import?</a></label>';
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_ai1ec_refresh_tokens'                       , array( $this, 'refresh_tokens_ajax' ) );
	...
	public function facebook_instance_factory() {
		if( ! isset( $this->facebook ) ) {
			...
			$facebook = new Ai1ec_Facebook_Proxy( array(
