 ...
 *
 * This class is responsible for rendering the Theme Options page (customizing
 * LESS variables).
 */
...
class Ai1ec_Less_Variables_Editing_Page extends Ai1ec_Page
{
	 ...
	 * I took this out of the factory so that it is done only if the page
	 * is clicked
	 */
	private function add_renderables_to_page() {
		...
		$bootstrap_tabs_layout =
			Ai1ec_Helper_Factory::create_bootstrap_tabs_layout_instance();
		$bootstrap_tabs_layout->set_layout( 'left' );
		$less_variables = Ai1ec_Lessphp_Controller::get_saved_variables(
