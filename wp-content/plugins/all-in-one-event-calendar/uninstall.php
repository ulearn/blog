...
if( defined( 'WP_UNINSTALL_PLUGIN' ) ) {
	...
	// Delete our notifications cron
	wp_clear_scheduled_hook( Ai1ec_Notification_Controller::CRON_HOOK );

	// Delete notifications hook version
	delete_option( Ai1ec_Notification_Controller::CRON_OPTION );
	...
	// Delete saved notifications list
	delete_option( Ai1ec_Notification_Controller::SAVED_NOTIFICATIONS );
